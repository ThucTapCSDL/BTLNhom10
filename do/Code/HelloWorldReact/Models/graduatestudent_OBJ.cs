...
namespace IS.uni{
public class graduatestudent_OBJ
{
...
//##fieldList##
	...
	public graduatestudent_OBJ()
	{
		_ID = new BusinessObjectID();
	}

	public graduatestudent_OBJ(BusinessObjectID id)
	{
		_ID = new BusinessObjectID();
		_ID = id;
	}
    ...
    [Display(Name="Mã đợt tốt nghiệp")]
    public virtual System.String graduationperiodcode
    {
        get ;
        set ;
    }
