...
//                AppRendered.loadData();
    ...
    setEdit: function (title, obj) {
        ...
        else
        {
            ...
            $("#NOTE").val(obj.NOTE);
            $("#UNIVERSITYCODE").val(obj.UNIVERSITYCODE);
            $("#LANG").val(obj.LANG);
        ...
        return (
            //Hiển thị một phần tử trên danh sách
			  <tr>
				  ...
				  <td>{this.props.item.UNIVERSITYCODE}</td>
				  <td>{this.props.item.LANG}</td>
...
var NewRow = React.createClass({
    ...
    handleSubmit: function () {
        ...
        console.log("lock");
        var UNIVERSITYCODE = this.refs.UNIVERSITYCODE.getDOMNode().value;
            ...
            <form className="form-horizontal">
                                            <div className="box-body">
                                                <div className="form-group col-sm-12">
                                                 ...
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Mã trường</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="UNIVERSITYCODE" id="UNIVERSITYCODE" />
                                                    </div>
                                                 </div>
                                                 <div className="form-group col-sm-12">
                                                    <label className="col-sm-4 control-label">Ngôn ngữ</label>
                                                    <div className="col-sm-8">
                                                        <input type="text" className="form-control" ref="LANG" id="LANG" />
                                                    </div>
                                                 </div>
